...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={panelRef} data-notification-bell>
      ...
      {isOpen && (
        <div data-notification-bell className="fixed top-0 left-0 max-lg:bottom-0 lg:left-20 z-50 flex h-screen w-full lg:w-[30rem] flex-col border-r border-border bg-card shadow-2xl animate-in slide-in-from-left-2 duration-200 pt-[env(safe-area-inset-top,0px)] lg:pt-0">
