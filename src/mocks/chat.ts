...
const EXISTING_DM_MESSAGES: Record<string, Message[]> = {
  'dm-aang': [
    ...
    { id: 'da5', groupId: 'dm-aang', senderId: 'aang', content: 'Mockup mobile.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang2/400/600', fileName: 'mockup-mobile.png', fileSize: 312000, createdAt: new Date('2026-07-10T10:20') },
    { id: 'da6', groupId: 'dm-aang', senderId: DEV_USER_ID, content: 'Screencast_review.mp4', type: 'video', fileUrl: 'https://picsum.photos/seed/vid1/400/400', fileName: 'screencast_review.mp4', fileSize: 5242880, duration: 32, createdAt: new Date('2026-07-10T10:22') },
  ],
  'dm-bambang': [
