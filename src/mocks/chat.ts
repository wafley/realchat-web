...
const EXISTING_DM_MESSAGES: Record<string, Message[]> = {
  'dm-aang': [
    ...
    { id: 'da18', groupId: 'dm-aang', senderId: 'aang', content: 'banner-utama.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang10/400/400', fileName: 'banner-utama.png', fileSize: 195000, createdAt: new Date('2026-07-10T11:00') },
    { id: 'da19', groupId: 'dm-aang', senderId: 'aang', content: 'hero-section.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang11/400/400', fileName: 'hero-section.png', fileSize: 310000, createdAt: new Date('2026-07-10T11:02') },
    { id: 'da20', groupId: 'dm-aang', senderId: DEV_USER_ID, content: 'hasil-edit-1.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang12/400/400', fileName: 'hasil-edit-1.png', fileSize: 178000, createdAt: new Date('2026-07-10T11:05') },
    { id: 'da21', groupId: 'dm-aang', senderId: 'aang', content: 'revisi-font.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang13/400/400', fileName: 'revisi-font.png', fileSize: 220000, createdAt: new Date('2026-07-10T11:10') },
    { id: 'da22', groupId: 'dm-aang', senderId: 'aang', content: 'mockup-desktop.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang14/400/400', fileName: 'mockup-desktop.png', fileSize: 340000, createdAt: new Date('2026-07-10T11:15') },
    { id: 'da23', groupId: 'dm-aang', senderId: DEV_USER_ID, content: 'perbaikan-warna.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang15/400/400', fileName: 'perbaikan-warna.png', fileSize: 205000, createdAt: new Date('2026-07-10T11:20') },
    { id: 'da24', groupId: 'dm-aang', senderId: 'aang', content: 'thumb-card.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang16/400/400', fileName: 'thumb-card.png', fileSize: 165000, createdAt: new Date('2026-07-10T11:25') },
    { id: 'da25', groupId: 'dm-aang', senderId: 'aang', content: 'ilustrasi-baru.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang17/400/400', fileName: 'ilustrasi-baru.png', fileSize: 290000, createdAt: new Date('2026-07-10T11:30') },
    { id: 'da26', groupId: 'dm-aang', senderId: DEV_USER_ID, content: 'kompresi-aset.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang18/400/400', fileName: 'kompresi-aset.png', fileSize: 140000, createdAt: new Date('2026-07-10T11:35') },
    { id: 'da27', groupId: 'dm-aang', senderId: 'aang', content: 'dark-mode-ui.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang19/400/400', fileName: 'dark-mode-ui.png', fileSize: 265000, createdAt: new Date('2026-07-10T11:40') },
    { id: 'da28', groupId: 'dm-aang', senderId: 'aang', content: 'light-mode-ui.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang20/400/400', fileName: 'light-mode-ui.png', fileSize: 255000, createdAt: new Date('2026-07-10T11:42') },
    { id: 'da29', groupId: 'dm-aang', senderId: DEV_USER_ID, content: 'approved-vercel.png', type: 'image', fileUrl: 'https://picsum.photos/seed/aang21/400/400', fileName: 'approved-vercel.png', fileSize: 185000, createdAt: new Date('2026-07-10T11:45') },
  ],
  'dm-bambang': [
